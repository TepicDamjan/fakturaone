      ...
      >
        ...
        <label className="block mt-4 text-sm font-medium text-fcrna">
          ...
          <textarea
            ...
            className="mt-1.5 w-full rounded-lg border border-gray-200 px-3 py-2 text-sm text-fcrna placeholder:text-[#94A3B8] focus:outline-none focus:ring-2 focus:ring-fplava/30 focus:border-fplava disabled:opacity-60"
          />
        </label>
