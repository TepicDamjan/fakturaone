            ...
            <div>
                ...
                <div className='bg-white rounded-lg m-8 p-6 border border-gray-100 shadow-sm'>
                    ...
                    <div className="relative max-w-md">
                        <select
                            className="w-full appearance-none bg-white border border-gray-200 text-[#0F172A] text-sm rounded-lg focus:ring-2 focus:ring-[#137FEC]/20 focus:border-[#137FEC] block p-3 pr-8 transition-all shadow-sm outline-none cursor-pointer hover:border-gray-300"
                            defaultValue=""
                        >
                    ...
                    <input className='text-sm' placeholder='#12/26'></input>
                    <label className='block text-sm font-bold text-[#0F172A] mb-2'>Referenca</label>
